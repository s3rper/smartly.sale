...
</div> </div> ${renderComponent($$result2, "Hero", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/app/src/components/Hero", "client:component-export": "default" })} ${renderComponent($$result2, "FeaturedProducts", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/app/src/components/FeaturedProducts", "client:component-export": "default" })} ${renderComponent($$result2, "PopularPosts", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/app/src/components/PopularPosts", "client:component-export": "default" })}  <div class="w-full bg-muted py-8 text-center border-y"> <div class="max-w-7xl mx-auto px-4"> <div class="bg-background rounded-lg shadow-sm p-8 text-muted-foreground">
Advertisement Space (970x250)
</div> </div> </div> ${renderComponent($$result2, "CategoryGrid", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/app/src/components/CategoryGrid", "client:component-export": "default" })}  <div class="w-full bg-muted py-8 text-center border-t"> <div class="max-w-7xl mx-auto px-4"> <div class="bg-background rounded-lg shadow-sm p-8 text-muted-foreground">
Advertisement Space (728x90)
</div> </div> </div> ` })}`;
